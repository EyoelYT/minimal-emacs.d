...
(use-package tab-bar
  ...
  (define-leader-keys
   "v"           '(                           :wk "tab-bar" :ignore t)
   "v ."         '(tab-bar-select-tab-by-name :wk "select tab by name")
   "v v"         '(+tab-bar-show-tabs         :wk "show tabs")
   "v N"         '(+tab-bar-new-named-tab     :wk "new named tab")
   "v n"         '(tab-bar-new-tab            :wk "new tab")
   "v r"         '(tab-bar-rename-tab         :wk "rename tab")
   "v d"         '(tab-bar-close-tab          :wk "close tab")
   "v S-<right>" '(tab-bar-move-tab           :wk "move tab right")
   "v S-<left>"  '(tab-bar-move-tab-backward  :wk "move tab left"))
