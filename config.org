...
(use-package elisp-demos
  ...
  (advice-add #'elisp-demos--export-json-file #'+elisp--optimize-org-init-a)
  (advice-add #'elisp-demos--symbols #'+elisp--optimize-org-init-a)
  (advice-add #'elisp-demos--syntax-highlight #'+elisp--optimize-org-init-a))
#+end_src
