...
(use-package package-loading-notifier
  ;; :hook (after-init . package-loading-notifier-mode)
  :defer t
  :config
...
;; Set the GPG program and home directory
;; (setq epg-gpg-program "gpg")
;; (setq epg-gpg-home-directory (expand-file-name "~/.gnupg"))

;; Temporarily disable signature checking to refresh package contents
(unless package-archive-contents
  (let ((package-check-signature nil))
    (package-refresh-contents)))

;; Re-enable signature checking after refreshing contents
...
(use-package diff-ansi
  :ensure t
  :defer t
  :vc (:url "https://codeberg.org/ideasman42/emacs-diff-ansi")
...
(use-package vscdark-theme
  :vc (:url "https://github.com/EyoelYT/vscdark-theme"))
...
(use-package kanagawa-themes
  :vc (:url "https://github.com/EyoelYT/kanagawa-emacs")
  :config
...
(use-package tangonov-theme
  :vc (:url "https://codeberg.org/trevdev/tangonov-theme"))
...
(use-package consult-everything
  ...
  :vc (:url "https://github.com/jthaman/consult-everything")
  :after consult
  :ensure t
  :defer t)
...
(use-package doom-snippets
  ...
  ;; :load-path (expand-file-name "doom-snippets/" minimal-emacs-var-dir)
  :after yasnippet
  :preface
  (setq doom-snippets-dir (expand-file-name "doom-snippets/" package-user-dir)))
#+end_src
