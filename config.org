...
(defun ey/add-stuff-to-default-buffer-alist ()
  ...
  ;; (add-to-list 'default-frame-alist '(font . "MonacoLigaturized Nerd Font-14"))
  ;; (add-to-list 'default-frame-alist '(font . "FantasqueSansM Nerd Font-15"))
  ;; (add-to-list 'default-frame-alist '(alpha . 99))
  ;; (add-to-list 'default-frame-alist '(alphaBackground . 50))
  ;; (add-to-list 'default-frame-alist '(undecorated . t))
  ;; (add-to-list 'default-frame-alist '(fullscreen . fullboth))
  ;; (add-to-list 'default-frame-alist '(width . 168)) ; was 166
  ;; (add-to-list 'default-frame-alist '(height . (text-pixels . 1400)))
...
(with-eval-after-load 'evil
  ...
  (with-eval-after-load 'evil-multiedit
    ...
    ;; (evil-define-key '(insert) evil-multiedit-mode-map (kbd "<return>") nil) ; To have RET insert newlines in multiedit modes
    ;; (evil-define-key '(insert) evil-multiedit-mode-map (kbd "RET") nil)
...
(with-eval-after-load 'evil
  (with-eval-after-load 'org
    ...
    (define-key org-mode-map  (kbd "<backspace>") 'evil-delete-backward-char-and-join)
    ...
    ;; (evil-define-key nil org-mode-map (kbd "g l") nil)
    (evil-define-key '(normal visual motion) org-mode-map (kbd "gl") 'evil-lion-left) ; TODO: check if not working currently
    ))
...
(with-eval-after-load 'org
  (define-leader-keys
   ...
   "m ."   '(consult-org-heading         :which-key "consult-org-heading")
   "m /"   '(consult-org-agenda          :which-key "consult-org-agenda")
   "m s r" '(org-refile                  :which-key "consult-org-agenda")
...
;; (global-set-key (kbd "C-S-i") 'ey/visual-to-first-non-blank-in-current-line)
;; (global-set-key (kbd "C-S-a") 'ey/visual-to-last-non-blank-in-current-line)
...
(with-eval-after-load 'evil
  ...
  (evil-define-key '(visual insert motion) global-map (kbd "C-S-p") 'project-compile)
  (define-key global-map (kbd "<backspace>")                        'evil-delete-backward-char-and-join)
...
(with-eval-after-load 'evil
  (with-eval-after-load 'magit
    ...
    ;; (evil-define-key '(normal) magit-section-mode-map (kbd "<backtab>")         nil)
    ...
    ;; (evil-define-key '(visual normal) magit-mode-map (kbd "C-<tab>")            'evil-switch-to-windows-last-buffer)
    ;; (evil-define-key '(visual normal) magit-mode-map (kbd "C-S-<tab>")          'magit-section-cycle-global)
    ;; (evil-define-key '(visual normal) magit-diff-section-base-map (kbd "S-<return>") 'magit-diff-visit-worktree-file-other-window)
    ;; (evil-define-key '(visual normal) magit-diff-section-map (kbd "S-<return>") 'magit-diff-visit-worktree-file-other-window)
    )) ; TODO: remove commented if no side effects
...
(with-eval-after-load 'evil
  ...
  ;; (define-leader-keys "`" '(+popup/toggle :which-key "+popup/toggle"))
...
(with-eval-after-load 'evil
  (with-eval-after-load 'corfu
    ...
    ;; (evil-define-key 'insert corfu-map [tab] #'corfu-next) ; TODO: unnedded??
    (evil-define-key 'insert corfu-map (kbd "S-TAB") #'corfu-previous)
    ;; (evil-define-key 'insert corfu-map [backtab] #'corfu-previous) ; TODO: unnedded??
    ))
#+end_src
